...
var chunk_ZIFBTC6Y_exports = {};
__export(chunk_ZIFBTC6Y_exports, {
  getPackedPackage: () => getPackedPackage,
  require_p_map: () => require_p_map
});
module.exports = __toCommonJS(chunk_ZIFBTC6Y_exports);
...
var require_lib = (0, import_chunk_4VNS5WPM.__commonJS)({
  "../../node_modules/.pnpm/npm-normalize-package-bin@2.0.0/node_modules/npm-normalize-package-bin/lib/index.js"(exports, module2) {
    "use strict";
    var { join, basename } = (0, import_chunk_4VNS5WPM.__require)("path");
...
var require_common = (0, import_chunk_4VNS5WPM.__commonJS)({
  "../../node_modules/.pnpm/glob@8.1.0/node_modules/glob/common.js"(exports) {
    ...
    var isAbsolute = (0, import_chunk_4VNS5WPM.__require)("path").isAbsolute;
...
async function getPackedPackage(name, target, packageDir) {
  packageDir = packageDir || await (0, import_chunk_MY5KA4VU.resolvePkg)(name, { basedir: process.cwd() }) || await (0, import_chunk_MY5KA4VU.resolvePkg)(name, { basedir: target });
  if (!packageDir) {
    const pkg = (0, import_chunk_PSFQKG2Q.readPackageUpSync)({
      cwd: target,
      normalize: false
    });
