...
var chunk_PJ4PJ35Z_exports = {};
__export(chunk_PJ4PJ35Z_exports, {
...
module.exports = __toCommonJS(chunk_PJ4PJ35Z_exports);
...
[Context: getConfig]`;
    super((0, import_chunk_YEB5HGYT.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_5DBOS77Y.tryCatch)(
      () => {
        ...
        const data = import_chunk_5BZKOCL2.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
