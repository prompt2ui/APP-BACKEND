...
function protocolToConnectorType(protocol) {
  switch (protocol) {
    case "postgresql:":
    case "postgres:":
    case import_chunk_CYQLJPPO.PRISMA_POSTGRES_PROTOCOL:
      return "postgresql";
    case "mongodb+srv:":
    case "mongodb:":
      return "mongodb";
